...
class MockRegisterRepository extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.AuthUserInfo> register(
    String? name,
    String? email,
    String? password,
  ) =>
...
/// A class which mocks [RegisterAPIRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockRegisterAPIRepository extends _i1.Mock
    implements _i2.RegisterAPIRepository {
  MockRegisterAPIRepository() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i4.Future<void> sendUserToBackend(_i2.AuthUserInfo? user) =>
      (super.noSuchMethod(
            Invocation.method(#sendUserToBackend, [user]),
