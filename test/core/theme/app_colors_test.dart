...
void main() {
  group('AppColors', () {
    test('Color constants have correct values', () {
      expect(AppColors.primary, const Color(0xFF236BEB));
      ...
      expect(AppColors.getDisabledPostButtonColor(Brightness.light),
          const Color(0xFFC0D2F4));
      expect(AppColors.getDisabledPostButtonColor(Brightness.dark),
